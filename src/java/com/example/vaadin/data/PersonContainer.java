...
public class PersonContainer  extends BeanItemContainer<Person> implements Serializable {
    ...
    public static final Object[] NATURAL_COL_ORDER = new Object[]{
        "firstName", "lastName", "email", "phoneNumber", "streetAddress", "postalCode", "city"
    };
    /*
     ...
     */
    public static final String[] COL_HEADERS_GERMAN = new String[] {
        "Vorname", "Nachname", "Email", "Telefonnummer", "Straße", "Postleitzahl", "Ort"
    };
